...
$w_routes = array(
        ...
        ['GET|POST',    '/admin-about-update',                  'Admin#adminAbout',                     'admin_about'],
        ['GET|POST',    '/admin-about',                         'Admin#getAbout',                       'admin_get_about'],
        ['GET|POST',    '/admin-menu',                          'Admin#displayAdminMenuPage',           'display_admin_menu_page'],
        ['GET|POST',    '/admin-account',                       'Admin#adminAccount',                   'admin_admin_account'],
        ['GET|POST',    '/admin-account',                       'Admin#accountModification',            'admin_account_modification'],        
        );