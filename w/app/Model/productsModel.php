...
class ProductsModel extends Model
{
	public function findProductsByCategory($id)
	{
		...
		$sql = 'SELECT products.id, products.name, products.description, products.price, products.picture, products.id_category FROM products INNER JOIN categories ON categories.id = products.id_category WHERE categories.id = :id AND visibility = 1 AND deleted = 0 ORDER BY products.position';
